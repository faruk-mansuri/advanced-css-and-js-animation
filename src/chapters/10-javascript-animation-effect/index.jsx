...
import JavascriptTabNavigationAnimation from './11-JavascriptTabNavigationAnimation';
import CSSSkewEffect from './12-CSSSkewEffect';
import VideoSlider from './13-VideoSlider';
import CoolGlitchEffect from './14-CoolGlitchEffect';
import SplitScreenOnScroll from './15-SplitScreenOnScroll';
import ToggleActionMenu from './16-ToggleActionMenu';
import NineDotsToggle from './17-NineDotsToggle';
  ...
  return (
    <div className='w-full h-full bg-slate-200 py-10'>
      ...
      <div>
        ...
        <JavascriptTabNavigationAnimation />
        <CSSSkewEffect />
        <VideoSlider />
        <CoolGlitchEffect />
        <SplitScreenOnScroll />
